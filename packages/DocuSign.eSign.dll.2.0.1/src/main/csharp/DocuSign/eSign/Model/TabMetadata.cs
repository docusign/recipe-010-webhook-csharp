...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TabMetadata :  IEquatable<TabMetadata>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>When set to **true**, the anchor string in this tab will match whole words only, not strings embedded in other strings. The default is **true**.</value>
        ...
        /// </summary>
        /// <value>if **true**, the anchor string does not consider case when matich strings in the document. The default is **true**.</value>
        ...
        /// </summary>
        /// <value>Determines the alignment of anchor tabs with anchor strings. Possible values are **left** or **right**. The default is **left**.</value>
