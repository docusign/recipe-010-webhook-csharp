...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountInformation :  IEquatable<AccountInformation>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>If **true**, then the transaction rooms feature exposed via the Workspaces API is avaiable enabled.</value>
